...
(function($, undefined) {
	...
	function parseUri(url, strictMode) {
		var str = decodeURI(url), res = parser[strictMode || false ? "strict"
				: "loose"].exec(str), uri = {
			attr : {},
			param : {},
			seg : {}
		...
		uri.attr['base'] = uri.attr.host ? uri.attr.protocol + "://"
	...
	$.url = function(url, strictMode) {
		...
		return {
			...
			toString : function() {
				...
				return this.data.attr['base'] + '/' + this.data.seg.path.join('/')
						+ '/?' + param.join('&');
			}
		};
	};
