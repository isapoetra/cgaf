...
class A extends Element {
	protected $href;
	protected $type;
	function __construct($content, $href = "", $type = "simple") {
		parent::__construct('text:a', $content, Document::NS_TEXT);
		$this->href = $href;
		$this->type = $type;
	}
	function _postAppendChild() {
		$this->setLink($this->href, $this->type);
	}
	function setLink($href, $type = "simple") {
		$this->setAttribute('xlink:href', $href);
		$this->setAttribute('xlink:type', $type);
	}
}
