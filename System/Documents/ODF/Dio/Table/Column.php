...
use System\Documents\ODF\Dio\Style\Properties\TableColumn;
...
class Column extends Element {
	...
	function __construct($index, $name = "") {
		static $count = 0;
		parent::__construct('table:table-column', null, Document::NS_TABLE);
		$this->_index = $index;
		$this->_id = ++$count;
		is_array($name) ? ppd($name) : '';
	...
	function _postAppendChild() {
		...
		$ps = $this->_style->addProperties(new TableColumn());
