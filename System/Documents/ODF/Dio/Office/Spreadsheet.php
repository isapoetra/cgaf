...
class Spreadsheet extends Element {
	function __construct() {
		parent::__construct('office:spreadsheet', null, Document::NS_OFFICE);
	}
	function addTable($name, $headers = array()) {
		$table = new Table($headers);
		$table = $this->appendChild($table);
		$table->name = $name;
		return $table;
	}
}
