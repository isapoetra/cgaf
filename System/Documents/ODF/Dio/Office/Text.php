...
use System\Documents\ODF\Document;
use System\Documents\ODF\Dio\Text\H;
use System\Documents\ODF\Dio\Element;
class Text extends Element {
	protected $current_level;
	function __construct() {
		parent::__construct('office:text', null, Document::NS_OFFICE);
		$this->current_level = 0;
	}
	function openSection($heading = '') {
		$this->current_level++;
		$h = $this->appendChild(new H($heading, $this->current_level));
	...
	function addP($content) {
		return $this->appendChild(new P($content));
	}
}
