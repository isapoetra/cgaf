 ...
 */
use System\Documents\ODF\Dio\Exceptions\PropertyValueInvalidException;
use System\Documents\ODF\Dio\Style\Properties;
class Paragraph extends Properties {
	...
	function setMargins($margins) {
		...
		case 4:
			...
			break;
		default:
			throw new PropertyValueInvalidException("Too many margins defined : " . implode(", ", $args) . ".");
		}
	...
	function setKeepWithNext($keep = 'auto') {
		...
		if (!in_array($keep, $values))
			throw new PropertyValueInvalidException("Invalid Keep With Next value : '" . $keep . "'.");
