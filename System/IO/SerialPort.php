 ...
 *         @thanks Aur�lien Derouineau for finding how to open serial ports
 *         with windows
 *         @thanks Alec Avedisyan for help and testing with reading
 * @copyright under GPL 2 licence
 */

class SerialPort implements \IIODevice {
	...
	var $_windevice = null;
	var $_dHandle = null;
	var $_dState = SerialPort::SERIAL_DEVICE_NOTSET;
	var $_buffer = "";
	var $_os = "";
	/**
	...
	/**
	 * Constructor.
	 * Perform some checks about the OS and setserial
	 * 
	 * @return phpSerial
	 */
	 ...
	 * 
	 * @param $mode string
	 *       	 Opening mode : same parameter as fopen()
	 * @return bool
	 */
	 ...
	 * 
	 * @param $length float
	 *       	 the length of a stop bit. It must be either 1,
