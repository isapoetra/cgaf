...
abstract class Utils {
	...
	public static function makeDir($pathname, $mode = 0700, $securepatern = null) {
	...
	public static function copyFile($source, $dest, $options = array("overwrite"=>false, 'folderPermission'=>0755,'removeSoure'=>false,'filePermission'=>0755), $callback = null, $callbackparam = null) {
	...
	public static function arrayImplode($assoc_array, $k_v_glue = '=', $seperator = ',', $ignore = '', $quote = null,$ignoreEmpyValue=false) {
		...
		foreach ( $assoc_array as $k => $v ) {
			...
			if (! $i) {
				...
				if ($ignoreEmpyValue && (is_null($v) || $v==='')) continue;
