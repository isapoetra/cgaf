...
class CSSCompressor extends AbstractCompressor
{
    ...
    {
        $this->_content = CommentPreserver::process($this->_content, array(
            $this,
            '_process'
        ), array(
            $this->_config
    ...
    protected function _commentCB($m)
    {
        ...
        if ($this->_inHack) {
            ...
            if (preg_match('@
                ...
                // end hack mode after this comment, but preserve the hack and
                // comment content
                $this->_inHack = false;
                return "/*/{$n[1]}/**/";
            }
        ...
        // Issue 107: if there's any surrounding whitespace, it may be
        // important, so
    ...
    function _process($css)
    {
        ...
        // separate common descendent selectors w/ newlines (to limit line
        // lengths)
