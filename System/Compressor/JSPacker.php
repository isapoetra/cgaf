...
class JSPacker
{
    ...
    private $LITERAL_ENCODING = array(
        'None' => 0, 'Numeric' => 10, 'Normal' => 62, 'High ASCII' => 95);
    ...
    private function _analyze($script, $regexp, $encode)
    {
        ...
        return array(
            'sorted' => $_sorted, 'encoded' => $_encoded, 'protected' => $_protected);
    }
        ...
        if (is_string($replacement)) {
            ...
            if (preg_match($this->SUB_REPLACE, $replacement)) {
                ...
                if (preg_match($this->INDEXED, $replacement)) {
                    ...
                    $replacement = array(
                        'fn' => '_backReferences', 'data' => array(
                            'replacement' => $replacement, 'length' => $length, 'quote' => $quote));
                }
            }
        }
