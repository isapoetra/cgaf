...
use \String,\Request,\System\ACL\ACLHelper;
use \Logger;
...
abstract class Controller extends \Object implements IController, \ISearchProvider {
	...
	function renderContent($position) {
		return $this->getAppOwner ()->renderContent ( $position, $this->getControllerName () );
	}
	...
	public  function getView($viewName, $a = null, $attr = null) {
		...
		if ($c) {
			...
			Logger::Warning('View Class Not found %s',$viewName);
		}
