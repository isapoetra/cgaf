...
abstract class MVCHelper
{
    ...
    public static function Initialize()
    {
        ...
        foreach ($shared as $s) {
            if (is_dir($s)) {
                CGAF::addClassPath('Models', $s . 'Models' . DS);
                CGAF::addClassPath('Controller', $s . 'Controllers' . DS, false);
            } else {
                \Logger::Warning("Unable to find shared path " . $s);
            }
        }
