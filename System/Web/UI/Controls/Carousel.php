...
class Carousel extends Control {
	...
	function prepareRender() {
		...
		$this->_control = '<a class="carousel-control left" href="#'.$this->getId().'" data-slide="prev"><img src="/asset/images/nav-left.png"/></a>'
		.'<a class="carousel-control right" href="#'.$this->getId().'" data-slide="next"><img src="/asset/images/nav-right.png"/></a>';
        if ($this->_customs) {
