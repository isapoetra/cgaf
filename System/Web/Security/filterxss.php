...
class FilterXSS implements IWebSecurity
{
    /**
...
// --------------------------------------------------------------------
    ...
    {
        return $this->entity_decode($match[0], strtoupper($this->getConfig('charset')));
    }
...
// --------------------------------------------------------------------
    ...
    public function clean($str, $is_image = false)
    {
        ...
        $str = $this->_validate_entities(\Utils::RemoveInvisibleCharacters($str));
...
// --------------------------------------------------------------------
    ...
    {
        return \AppManager::getInstance()->getConfig('security.' . $configName, null);
    }
}