...
abstract class BaseACL extends \Object implements IACL {
	...
	function grant($id, $group, $access = "view", $userid = null) {
		...
		if ($o) {
			...
			$o = $this->_q->clear()->addTable("user_privs")->addInsert("user_id", (int) $userid)->addInsert("app_id", $this->_q->quote($this->_appId))->addInsert("object_id", $this->_q->quote($id))->addInsert("object_type", $this->_q->quote($group))
