<?php
namespace System\Captcha\Zend;
use System\Exceptions\SystemException;

use System\Captcha\AbstractCaptcha;
use \CGAF;
...
class Image extends AbstractCaptcha {
	...
	protected function _initialize() {
		...
		try {
			...
			throw new SystemException('GD extension not loaded <br/> in debian linux please use the following command (as root) : apt-get install php5-gd ');
		}

		CGAF::isFunctionExist('imagecreatetruecolor', true);
		$font = $this->_container->getFont();
		if (!$font) {
			throw new SystemException('unable to get Font');
		}
	}
